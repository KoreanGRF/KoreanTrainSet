...
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/locomotive/CDC/CDC.png?raw=true) | ``CDC`` | skyu<br />[@telk5093](https://github.com/telk5093)<br />오픈기차<br /> | |
...
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/metro/busan_metro_1/BUSAN_METRO_1K_1ST.png?raw=true) | ``BUSAN_METRO_1K_1ST`` | 오픈기차 | |
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/metro/busan_metro_1/BUSAN_METRO_1K_2ND.png?raw=true) | ``BUSAN_METRO_1K_2ND`` | 오픈기차 | |
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/metro/busan_metro_2/BUSAN_METRO_2K.png?raw=true) | ``BUSAN_METRO_2K`` | 오픈기차 | |
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/metro/busan_metro_3/BUSAN_METRO_3K.png?raw=true) | ``BUSAN_METRO_3K`` | 오픈기차 | |
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/metro/daegu_metro_1/DAEGU_METRO_1K.png?raw=true) | ``DAEGU_METRO_1K`` | 오픈기차 | |
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/metro/daegu_metro_2/DAEGU_METRO_2K.png?raw=true) | ``DAEGU_METRO_2K`` | 오픈기차 | |
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/metro/daejeon_metro_1/DAEJEON_METRO_1K.png?raw=true) | ``DAEJEON_METRO_1K`` | 오픈기차 | |
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/metro/gwangju_metro_1/GWANGJU_METRO_1K.png?raw=true) | ``GWANGJU_METRO_1K`` | 오픈기차 | |
...
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/metro/seoul_metro_1/321K_BIKE.png?raw=true) | ``321K_BIKE`` | 오픈기차 | |
...
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/metro/seoul_metro_2/2K_RHEO_MODIFIED.png?raw=true) | ``2K_RHEO_MODIFIED`` | 오픈기차 | |
...
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/wagon/baggage_car/BAGGAGE_CAR.png?raw=true) | ``BAGGAGE_CAR`` | 오픈기차 | |
...
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/wagon/tongil_car/TONGIL_CAR.png?raw=true) | ``TONGIL_CAR`` | 오픈기차 | |
...
| ![img](https://github.com/KoreanGRF/KoreanTrainSet/blob/master/src/wagon/mugunghwa_car/G-train.png?raw=true) | ``G-train`` | 오픈기차 | |
