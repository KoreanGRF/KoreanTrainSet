<table class="ko_train_set">
    ...
    <tr data-veh_id="TONGIL_CAR">
        <td class="refit"><div><img src="./_static/TONGIL_CAR.png" alt="통일호 객차"></div></td>
    ...
    <tr data-veh_id="BIDULGI_CAR">
        <td class="refit"><div><img src="./_static/BIDULGI_CAR.png" alt="비둘기호 객차"></div></td>
