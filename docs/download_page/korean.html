<table class="ko_train_set">
    ...
    <tr data-veh_id="K2X00">
        <td class="refit"><div><img src="./_static/K2x00_BLACK_ORANGE.png" alt="2x00호대 디젤 기관차"><br /><img src="./_static/K2x00_GREEN_YELLOW.png" alt="2x00호대 디젤 기관차"></div></td>
    ...
    <tr data-veh_id="GENERATOR_CAR">
        <td class="refit"><div><img src="./_static/GENERATOR_CAR_A_wagon.png" alt="발전차"><br /><img src="./_static/GENERATOR_CAR_B_wagon.png" alt="발전차"><br /><img src="./_static/GENERATOR_CAR_GREEN_YELLOW_wagon.png" alt="발전차"><br /><img src="./_static/GENERATOR_CAR_BLUE_YELLOW_wagon.png" alt="발전차"><br /><img src="./_static/GENERATOR_CAR_A_TRAIN.png" alt="발전차"><br /><img src="./_static/HAERANG_GENERATOR_CAR.png" alt="발전차"><br /><img src="./_static/S_TRAIN_GENERATOR_CAR_1.png" alt="발전차"><br /><img src="./_static/S_TRAIN_GENERATOR_CAR_2.png" alt="발전차"><br /><img src="./_static/G_TRAIN_GENERATOR_CAR.png" alt="발전차"></div></td>
    ...
    <tr data-veh_id="CAFE_CAR">
        <td class="refit"><div><img src="./_static/CAFE_CAR_DHC_1.png" alt="카페/식당 객차"><br /><img src="./_static/CAFE_CAR_DHC_2.png" alt="카페/식당 객차"><br /><img src="./_static/CAFE_CAR_SAEMAEUL_RESTAURENT.png" alt="카페/식당 객차"><br /><img src="./_static/CAFE_CAR_DHC_3.png" alt="카페/식당 객차"><br /><img src="./_static/CAFE_CAR_MUGUNGHWA_RESTAURENT_C.png" alt="카페/식당 객차"><br /><img src="./_static/CAFE_CAR_MUGUNGHWA_RESTAURENT_D.png" alt="카페/식당 객차"><br /><img src="./_static/CAFE_CAR_MUGUNGHWA_CAFE_E.png" alt="카페/식당 객차"><br /><img src="./_static/CAFE_CAR_MUGUNGHWA_RESTAURANT_F.png" alt="카페/식당 객차"><br /><img src="./_static/CAFE_CAR_MUGUNGHWA_CAFE_RED_BLUE_WHITE.png" alt="카페/식당 객차"><br /><img src="./_static/CAFE_CAR_MUGUNGHWA_STREAMLINE.png" alt="카페/식당 객차"><br /><img src="./_static/CAFE_CAR_RDC.png" alt="카페/식당 객차"></div></td>
        <td class="name">카페/식당 객차</td>
        <td class="speed">120 km/h</td>
        <td class="speed_designed">120 km/h</td>
    ...
    <tr data-veh_id="INCHEON_METRO_1">
        <td class="refit"><div><img src="./_static/INCHEON_METRO_1K_VVVF_1ST.png" alt="인천 1호선"><br /><img src="./_static/INCHEON_METRO_1K_VVVF_2ND.png" alt="인천 1호선"></div></td>
