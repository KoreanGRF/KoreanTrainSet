<table class="ko_train_set">
    ...
    <tr data-veh_id="NURIRO">
        <td class="refit"><div><img src="./_static/NURIRO.png" alt="누리로"><br /><img src="./_static/NURIRO_KOREAN_WAVE.png" alt="누리로"><br /><img src="./_static/NURIRO_O_TRAIN.png" alt="누리로"></div></td>
    ...
    <tr data-veh_id="FLAT_CAR">
        <td class="refit"><div><img src="./_static/FLAT_CAR_1.png" alt="컨테이너 평판화차"></div></td>
