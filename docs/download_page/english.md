<table class="ko_train_set">
    ...
    <tr data-veh_id="K5000">
        <td class="refit"><div><img src="./_static/K5000_BLACK_ORANGE.png" alt="5·6000 Diesel Locomotive"></div></td>
        <td class="name">5·6000 Diesel Locomotive</td>
        <td class="speed">105 km/h</td>
        <td class="speed_designed">105 km/h</td>
        <td class="capacity"></td>
    ...
    <tr data-veh_id="NURIRO">
        <td class="refit"><div><img src="./_static/NURIRO.png" alt="Nuriro"><br /><img src="./_static/NURIRO_KOREAN_WAVE.png" alt="Nuriro"><br /><img src="./_static/NURIRO_O_TRAIN.png" alt="Nuriro"><br /><img src="./_static/NURIRO_SANTA.png" alt="Nuriro"></div></td>
