<table class="ko_train_set">
    ...
    <tr data-veh_id="NURIRO">
        <td class="refit"><div><img src="./_static/NURIRO.png" alt="Nuriro"><br /><img src="./_static/NURIRO_KOREAN_WAVE.png" alt="Nuriro"><br /><img src="./_static/NURIRO_O_TRAIN.png" alt="Nuriro"></div></td>
    ...
    <tr data-veh_id="NDC">
        <td class="refit"><div><img src="./_static/NDC_1.png" alt="New Diesel Car (NDC)"><br /><img src="./_static/NDC_business.png" alt="New Diesel Car (NDC)"><br /><img src="./_static/NDC_2.png" alt="New Diesel Car (NDC)"></div></td>
    ...
    <tr data-veh_id="TONGIL_CAR">
        <td class="refit"><div><img src="./_static/TONGIL_CAR.png" alt="Tongil passenger car"></div></td>
    ...
    <tr data-veh_id="BIDULGI_CAR">
        <td class="refit"><div><img src="./_static/BIDULGI_CAR.png" alt="Bidulgi passenger car"></div></td>
    ...
    <tr data-veh_id="GENERATOR_CAR">
        <td class="refit"><div><img src="./_static/GENERATOR_CAR_A_wagon.png" alt="Generator car"><br /><img src="./_static/GENERATOR_CAR_B_wagon.png" alt="Generator car"><br /><img src="./_static/GENERATOR_CAR_GREEN_YELLOW_wagon.png" alt="Generator car"><br /><img src="./_static/GENERATOR_CAR_BLUE_YELLOW_wagon.png" alt="Generator car"><br /><img src="./_static/GENERATOR_CAR_A_TRAIN.png" alt="Generator car"><br /><img src="./_static/HAERANG_GENERATOR_CAR.png" alt="Generator car"><br /><img src="./_static/S_TRAIN_GENERATOR_CAR_1.png" alt="Generator car"><br /><img src="./_static/S_TRAIN_GENERATOR_CAR_2.png" alt="Generator car"><br /><img src="./_static/G_TRAIN_GENERATOR_CAR.png" alt="Generator car"></div></td>
    ...
    <tr data-veh_id="INCHEON_METRO_1">
        <td class="refit"><div><img src="./_static/INCHEON_METRO_1K_VVVF_1ST.png" alt="Incheon Line 1"><br /><img src="./_static/INCHEON_METRO_1K_VVVF_2ND.png" alt="Incheon Line 1"></div></td>
